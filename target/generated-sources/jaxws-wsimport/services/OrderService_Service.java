 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://Services/", wsdlLocation = "http://localhost:8080/Soap-Service/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://Services/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Soap-Service/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://Services/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services/", "OrderServicePort"), OrderService.class, features);
    }
