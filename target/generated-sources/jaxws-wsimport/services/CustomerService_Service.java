 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://Services/", wsdlLocation = "http://localhost:8080/Soap-Service/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://Services/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Soap-Service/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://Services/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services/", "CustomerServicePort"), CustomerService.class, features);
    }
